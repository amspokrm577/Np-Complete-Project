...
test1= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input1.txt
echo $test1
if [ "$test1" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: $test1"
test2= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input2.txt
echo $test2
if [ "$test2" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: "
test3= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input3.txt
echo $test3
if [ "$test3" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: "
test4= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input4.txt
echo $test4
if [ "$test4" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: "
test5= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input5.txt
echo $test5
if [ "$test5" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: "
test5= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input6.txt
echo $test5
if [ "$test5" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: "
test5= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input7.txt
echo $test5
if [ "$test5" == "$expected" ]
then
    echo "Test Passed"
...
echo -e $divider
echo "Actual Output: "
test5= /usr/bin/time -f "\nRun time: %e sec" python exact_solution.py < input8.txt
echo $test5
if [ "$test5" == "$expected" ]
then
    echo "Test Passed"
